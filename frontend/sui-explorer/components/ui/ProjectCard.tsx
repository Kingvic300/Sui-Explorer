...
import { ChevronRightIcon as ChevronRight, StarIcon, TwitterIcon, DiscordIcon } from '../icons/MiscIcons';
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="border-t border-light-border dark:border-blue-900/40 pt-4 flex justify-between items-center">
