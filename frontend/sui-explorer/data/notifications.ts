...
export const notificationsData: Notification[] = [
    {
        id: 1,
        type: 'new_project',
        title: 'New Project: Cetus Protocol',
        description: 'A pioneer DEX & concentrated liquidity protocol just launched. Check it out!',
    ...
    },
    {
        id: 4,
        type: 'new_project',
        title: 'New Project: SuiFrens',
        description: 'An adorable, dynamic, on-chain companion collection has been submitted.',
    ...
    },
    {
        id: 6,
        type: 'review',
        title: 'Review on SuiSwap',
        description: '@DeFiChad rates SuiSwap 5/5 for its low fees and fast execution.',
    ...
    },
    {
        id: 7,
        type: 'new_project',
        title: 'New Project: Scallop',
        description: 'The next generation money market is now live on Sui.',
    ...
    },
    {
        id: 8,
        type: 'update',
        title: 'Sui Network v1.10.0',
        description: 'The Sui network has been upgraded, bringing performance improvements.',
    ...
    },
    {
        id: 9,
        type: 'review',
        title: 'Review on Ethos Wallet',
        description: 'A user left a new review: "The slickest and most user-friendly wallet in crypto!"',
