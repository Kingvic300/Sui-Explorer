...
import { XLogo, ShareIcon } from './Icons';
...
const TweetCard: React.FC<{ tweet: Tweet }> = ({ tweet }) => {
    ...
    return (
        <div
            className="bg-indigo-950/40 p-5 rounded-2xl border border-blue-900/50 w-full h-full flex flex-col justify-between card-glow-border"
        >
            <div>
                <div className="flex items-center justify-between mb-3">
                    ...
                    <a href={tweet.link} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" onClick={(e) => e.stopPropagation()} aria-label={`View tweet by ${tweet.handle} on X`}>
            ...
            <div className="mt-4 pt-4 border-t border-blue-900/40 flex items-center justify-end">
                <button
                    onClick={handleShare}
...
const CommunitySection: React.FC<CommunitySectionProps> = ({ animatedBackgroundsEnabled }) => {
    ...
    useEffect(() => {
        setIsLoading(true);
        // Use dummy data directly for community pulse to ensure reliability
        setTimeout(() => {
            // Display top 3 trending posts for the landing page pulse
  ...
  return (
    <>
      <section id="community" className="relative py-20 lg:py-32 bg-indigo-950/40">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex -space-x-4">
                  <img className="inline-block h-14 w-14 rounded-full ring-2 ring-black" src="https://picsum.photos/seed/c1/100/100" alt="User 1" />
                  <img className="inline-block h-14 w-14 rounded-full ring-2 ring-black" src="https://picsum.photos/seed/c2/100/100" alt="User 2" />
                  <img className="inline-block h-14 w-14 rounded-full ring-2 ring-black" src="https://picsum.photos/seed/c3/100/100" alt="User 3" />
                  <img className="inline-block h-14 w-14 rounded-full ring-2 ring-black" src="https://picsum.photos/seed/c4/100/100" alt="User 4" />
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-blue-500 ring-2 ring-black">
            ...
            <div className="w-full">
                <div className="flex items-center mb-6">
                    ...
                    <h3 className="font-display text-xl font-bold text-white">See What's Happening</h3>
                </div>

                <div className="relative h-[240px] w-full">
                    {isLoading ? (
                        <div className="w-full h-full flex items-center justify-center bg-indigo-950/40 p-5 rounded-2xl border border-blue-900/50">
